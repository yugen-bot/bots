...
func (hu *HistoryUpdate) SetNumber(i int) *HistoryUpdate {
...
func (hu *HistoryUpdate) SetNillableNumber(i *int) *HistoryUpdate {
	if i != nil {
		hu.SetNumber(*i)
	}
	return hu
...
func (hu *HistoryUpdate) AddNumber(i int) *HistoryUpdate {
...
func (hu *HistoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := hu.mutation.AddedNumber(); ok {
		_spec.AddField(history.FieldNumber, field.TypeInt, value)
	}
...
// SetNumber sets the "number" field.
func (huo *HistoryUpdateOne) SetNumber(i int) *HistoryUpdateOne {
...
// SetNillableNumber sets the "number" field if the given value is not nil.
func (huo *HistoryUpdateOne) SetNillableNumber(i *int) *HistoryUpdateOne {
	if i != nil {
		huo.SetNumber(*i)
	}
	return huo
...
// AddNumber adds i to the "number" field.
func (huo *HistoryUpdateOne) AddNumber(i int) *HistoryUpdateOne {
