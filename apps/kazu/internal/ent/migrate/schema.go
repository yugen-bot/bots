...
var (
	...
	SettingsColumns = []*schema.Column{
		...
		{Name: "shame_role_id", Type: field.TypeString, Nullable: true},
		{Name: "remove_shame_role_after_highscore", Type: field.TypeBool, Default: false},
		{Name: "last_shame_user_id", Type: field.TypeString, Nullable: true},
