...
import (
	...
	"jurien.dev/yugen/hachimitsu/internal/listeners"
...
// InitDiscordBot connects the bot to Discord, registers all listeners and
// command handlers, then opens the gateway connection.
